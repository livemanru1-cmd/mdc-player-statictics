...
export const RATING_METRIC_HELP: Record<RatingMetricHelpKey, string> = {
  ...
  tbf: "ТБФ - текущая боевая форма за последние 30 дней. Берутся 10 последних боевых игр: их ELO корректируется типом события, силой соперника и победой/поражением. Если игр меньше 10, результат сглаживается.",
